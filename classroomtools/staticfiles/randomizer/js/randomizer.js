...
/*                var offsetsCol = document.getElementById('student-column').getBoundingClientRect();
    ...
    var setNames = function() {
        ...
        for(var n = 0; n < numberStudents; n++){   <!-- place the names on the screen -->
            ...
            var divSt1 = document.createElement('div');
            var divSt2 = document.createElement('div');
            divSt1.className = 'col-md-2';
            divSt2.className = 'col-md-2';
            document.body.appendChild(divSt1);
            divTag.id = divName;
